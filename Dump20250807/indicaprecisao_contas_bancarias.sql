...
CREATE TABLE `contas_bancarias` (
  ...
  `conta_com_digito` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`conta_id`),
  KEY `fk_conta_usuario` (`usuario_id`),
  CONSTRAINT `fk_conta_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`)
...
INSERT INTO `contas_bancarias` VALUES (1,1,'João Silva','12345678901','1990-01-01','Banco do Brasil','corrente','1234','12345-6'),(2,2,'Maria Santos','98765432100','1985-05-15','Itaú','poupanca','5678','98765-4');
